...
def main():
    """Main function of Windows.py"""
    user_name = getpass.getuser() 

    path = f"C:\\\\Users\\{user_name}\\Downloads"
    ...
    doc_folder = f"C:\\Users\\{user_name}\\Documents"
    pictures_folder = f"C:\\Users\\{user_name}\\Pictures"
    music_folder = f"C:\\Users\\{user_name}\\Music"
    ...
    for file in os.listdir(path):
        ...
        if os.path.isdir(file):
            path_to_file = f"C:\\Users\\{user_name}\\Downloads\\{file}"
